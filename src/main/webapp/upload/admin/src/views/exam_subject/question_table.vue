      ...
      <el-row class="rows row2">
          ...
          <el-col :xs="24" :sm="12" :lg="12" class="search_btn_1 btns">
              ...
              <el-button
                ...
                >删除</el-button
              >
              <el-button  v-if="user_group == '管理员' || $check_action('/exam_question_database/table', 'add')" class="float-right  search_btn_add" @click="$router.push('/question_view/view?exam_id=' + query.exam_id+'&subject_name='+this.$route.query.subject_name)">添加</el-button>
