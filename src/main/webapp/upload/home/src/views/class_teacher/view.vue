				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 班级教师 -->
							<div><span>班级教师</span></div>
							<view_class_teacher v-if="$check_action('/class_teacher/table','get')"></view_class_teacher>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_class_teacher from "../../components/diy/view_class_teacher.vue";
	export default {
		data() {
			return {
			};
