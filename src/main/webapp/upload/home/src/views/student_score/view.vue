				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 学生分数 -->
							<div><span>学生分数</span></div>
							<view_student_score v-if="$check_action('/student_score/table','get')"></view_student_score>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_student_score from "../../components/diy/view_student_score.vue";
	export default {
		data() {
			return {
			};
