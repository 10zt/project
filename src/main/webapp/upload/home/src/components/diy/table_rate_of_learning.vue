    ...
    <el-form label-position="right" :model="query" class="form p_4" label-width="120">
      ...
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
            ...
            <el-button v-if="user_group == '管理员' || $check_action('/rate_of_learning/table','add') || $check_action('/rate_of_learning/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
						
            <el-button v-if="user_group == '管理员' || $check_action('/rate_of_learning/table','del') || $check_action('/rate_of_learning/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
                        </el-col>
                ...
                <el-table-column fixed type="selection" tooltip-effect="dark" width="55">
                      ...
                      {{ get_user_student_users(scope.row['student_users']) }}
                               ...
                               v-if="user_group == '管理员' || $check_field('get','course_name')" min-width="200">
                                              ...
                                              <el-table-column prop="rate_of_learning" @sort-change="$sortChange" label="学习进度"
                               v-if="user_group == '管理员' || $check_field('get','rate_of_learning')" min-width="200">
                                </el-table-column>
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/rate_of_learning/table','set') || $check_action('/rate_of_learning/view','set') || $check_action('/rate_of_learning/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
        

      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
                     v-if="user_group == '管理员' || $check_action('/rate_of_learning/table','set') || $check_action('/rate_of_learning/view','set') || $check_action('/rate_of_learning/view','get')"
  ...
  export default {
    ...
    data() {
      return {
        ...
        showModal: false,
        // 获取数据地址
        url_get_list: "~/api/rate_of_learning/get_list?like=0",
        url_del: "~/api/rate_of_learning/del?",
