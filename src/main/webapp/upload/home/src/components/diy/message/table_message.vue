    ...
    <el-main class="bg table_wrap">
            ...
            <el-row class="rows row2">
                <el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap">
                    <el-col :xs="24" :sm="12" :lg="12" class="search_btn_1">
                        ...
                        <el-button v-if="user_group == '管理员' || $check_action('/message/table','del')"
                                   class="float-right search_btn_del" type="danger" @click="delInfo()">删除
                        </el-button>
        ...
        <el-table border :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%"
            ...
            <el-table-column fixed="right" label="操作" width="120">
                <template slot-scope="scope">
                    ...
                    <el-button @click="reply(scope.row)" v-if="user_group ==='管理员' && scope.row['reply_state']==0"
                               class="el-button el-button--small is-plain el-button--primary">回复
                    </el-button>
                    <el-button @click="show_reply(scope.row)" v-if="scope.row['reply_state']==1"
                               class="el-button el-button--small is-plain el-button--primary">查看回复
                    </el-button>
                </template>
            </el-table-column>
            <!-- /操作 -->
        ...
        <div class="mt text_center">
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                           ...
                           :page-sizes="[7, 10, 30, 100]" :page-size="query.size"
