	...
	<div class="diy_details_box diy_div_course_information">
		<div class="warp diy_warp">
			...
			<div class="details_btn_wrap">
																											<button class="btn btn-primary details_btn" v-if="$check_action('/learning_courses/edit','add')" @click="to_form('/learning_courses/edit')" ><span> 学习课程</span> </button>
																											<button class="btn btn-primary details_btn" v-if="$check_action('/course_information/details','set')" @click="change_praise()" ><span>点赞</span></button>
																<button class="btn btn-primary details_btn" v-if="$check_action('/course_information/details','set')" @click="change_collect()" ><span>收藏</span></button>
											</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var course_information_id = this.obj.course_information_id;
