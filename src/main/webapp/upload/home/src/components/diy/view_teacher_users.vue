		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="联系电话" prop="contact_phone_number">
						...
						v-if="user_group === '管理员' || (form_sub['teacher_users_id'] && $check_field('set','contact_phone_number')) || (!form_sub['teacher_users_id'] && $check_field('add','contact_phone_number'))">
					</el-input>
					<div v-else-if="$check_field('get','contact_phone_number')">{{form_sub['contact_phone_number']}}</div>
							</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','family_information') || $check_field('add','family_information') || $check_field('set','family_information')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="系别信息" prop="family_information">
												<el-input id="family_information" v-model="form_sub['family_information']" placeholder="请输入系别信息"
							  v-if="user_group === '管理员' || (form_sub['teacher_users_id'] && $check_field('set','family_information')) || (!form_sub['teacher_users_id'] && $check_field('add','family_information'))"></el-input>
					<div v-else-if="$check_field('get','family_information')">{{form_sub['family_information']}}</div>
											</el-form-item>
			</el-col>
			...
			return {
				...
				disabledObj:{
								"teachers_name_isDisabled": false,
										...
										"family_information_isDisabled": false,
							},
