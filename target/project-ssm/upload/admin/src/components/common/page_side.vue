    ...
    <el-menu-item index="/">
     ...
     <el-submenu index="user"
      ...
      <el-menu-item index="/user/table" v-show="user_group == '管理员'" @click="handleButtonClick(8)"><span>管理员</span></el-menu-item>
                                  <el-menu-item index="/teacher_users/table" v-show="user_group == '管理员' || $check_action('/teacher_users/table')" @click="handleButtonClick(8)">
                <span>教师用户</span></el-menu-item>
                                              <el-menu-item index="/student_users/table" v-show="user_group == '管理员' || $check_action('/student_users/table')" @click="handleButtonClick(8)">
                <span>学生用户</span></el-menu-item>
                                              <el-menu-item index="/class_teacher/table" v-show="user_group == '管理员' || $check_action('/class_teacher/table')" @click="handleButtonClick(8)">
                <span>班级教师</span></el-menu-item>
              ...
              <template slot="title"><i class="el-icon-s-opportunity"></i><span ref="customTemplate3">资源管理</span></template>
                  ...
                  <el-menu-item v-show="user_group == '管理员' || $check_action('/article_type/table')"
                    ...
                    <span>{{$page_title("/article_type/table") || "文章分类"}}</span>
                                  ...
                                  <el-submenu
                index="subject"
                v-show="$check_group(['/subject/table','/exam_question_database/table','/user_answer_wrong/table','/subject_exam/table'])"
            >
              <template slot="title"
              ><i class="el-icon-s-opportunity"></i><span ref="customTemplate5">考试管理</span></template
              >
              ...
              <el-menu-item
                  v-show="user_group == '管理员' || $check_action('/exam_question_database/table')"
              ...
              <el-menu-item
                  v-show="user_group == '管理员' || $check_action('/user_answer_wrong/table')"
                  index="/exam_subject/wrong_list"
              @click="handleButtonClick(5)"><span>错题记录</span>
              </el-menu-item>

              <el-menu-item
                  v-show="user_group == '管理员' || $check_action('/subject_exam/table')"
                  index="/exam_subject/exams_table"
              @click="handleButtonClick(5)"><span>试卷列表</span>
              </el-menu-item>
            </el-submenu>
  ...
  export default {
    ...
    computed: {
      auth() {
        ...
        var lt = [];
        let site_list = []
                                                                                                      site_list.push("learning_courses")
                                        site_list.push("rate_of_learning")
                                            let list = ["exam", "article", "article_type", "comment", "notice", "message","subject","exam_question_database","subject_exam","user_answer_wrong"];
                                      list.push("teacher_users");
                                        list.push("student_users");
                                        list.push("class_teacher");
