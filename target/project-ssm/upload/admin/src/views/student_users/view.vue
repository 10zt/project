		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="联系电话" prop="contact_phone_number">
						...
						v-if="user_group === '管理员' || (form_sub['student_users_id'] && $check_field('set','contact_phone_number')) || (!form_sub['student_users_id'] && $check_field('add','contact_phone_number'))">
					</el-input>
				...
				<el-form-item label="专业信息" prop="professional_information">
												<el-input id="professional_information" v-model="form_sub['professional_information']" placeholder="请输入专业信息"
							  v-if="user_group === '管理员' || (form_sub['student_users_id'] && $check_field('set','professional_information')) || (!form_sub['student_users_id'] && $check_field('add','professional_information'))"></el-input>
					<div v-else-if="$check_field('get','professional_information')">{{form_sub['professional_information']}}</div>
											</el-form-item>
			</el-col>
