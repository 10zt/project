<template>
	...
	<el-row class="rows row2">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/learning_courses/table','set') || $check_action('/learning_courses/view','set') || $check_action('/learning_courses/view','get') || $check_action('/学习进度/table','add') || $check_action('/学习进度/view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/learning_courses/table','set') || $check_action('/learning_courses/view','set') || $check_action('/learning_courses/view','get')"
						...
						<!--跨表按钮-->
							<el-button class="e-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/rate_of_learning/view')" v-if="user_group == '管理员' || $check_action('/rate_of_learning/table','add') || $check_action('/rate_of_learning/view','add')">
						<span>学习进度</span>
					</el-button>
							</div>
				</template>
