...
<!--    点击后台系统用户-教师用户页面-->
    <el-main class="bg table_wrap comtabel_t">
            ...
            <el-row class="rows row2">
                <el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
                    <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
                        ...
                        <el-button v-if="user_group == '管理员' || $check_action('/teacher_users/table','add') || $check_action('/teacher_users/view','add')"
                                @click="$router.push('./view?')">添加
                        </el-button>
                        <el-button
        ...
        <el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%"
            ...
            <el-table-column prop="family_information" @sort-change="$sortChange" label="系别信息"
                             v-if="user_group == '管理员' || $check_field('get','family_information')" min-width="200">
            </el-table-column>
