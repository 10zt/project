	...
	<div class="diy_home diy_list diy_course_information" id="diy_course_information_list">
		...
		<div class="diy_view_table">
			<table class="diy_table">
				<tr class="diy_row">
								<th class="diy_title" v-if="$check_field('get','course_name','/course_information/list')">
					课程名称
				</th>
										<th class="diy_title" v-if="$check_field('get','course_cover','/course_information/list')">
					课程封面
				</th>
													<th class="diy_title" v-if="$check_field('get','course_date','/course_information/list')">
					课程日期
				</th>
										</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
									<td class="diy_field diy_text" v-if="$check_field('get','course_name','/course_information/list')">
						<span>
							{{ o["course_name"] }}
						</span>
					</td>
											<td class="diy_field" v-if="$check_field('get','course_cover','/course_information/list')">
						<img class="diy_img" :src="$fullUrl(o['course_cover'])" />
					</td>
														<td class="diy_field diy_date" v-if="$check_field('get','course_date','/course_information/list')">
						<span>
							{{ $toTime(o["course_date"] ,"yyyy-MM-dd") }}
						</span>
					</td>
										</tr>
			</table>
		...
		<!-- 轮播 -->
		 ...
		 <div class="carousel ins_s">
                ...
                <div  v-for="(o, i) in  list" :key="i" class="slide" >
                    ...
                    <router-link :to="'/course_information/details?course_information_id=' + o['course_information_id']" class="lis_cont">
                        <div class="diy_list_img_box" v-if="imgList.length" >
    					        <div class="diy_row" v-for="(item, index) in imgList" :key="item + index" v-show="$check_field('get',item.name,'/course_information/details') && +item.is_img_list">
    						<div class="diy_title diy_list_img_title">
...
<script>
	export default {
		...
		methods: {
			...
			to_detail(v){
				this.$router.push("/course_information/details?course_information_id="+v.course_information_id)
			},
