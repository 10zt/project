    ...
    <el-main class="bg table_wrap">
                ...
                <el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap">
                    <el-col :xs="24" :sm="12" :lg="12" class="search_btn_1">
                        <el-form-item>
                            ...
                            <el-button v-if="user_group == '管理员' || $check_action('/comment/table','del')"
        ...
        <el-table border :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%"
            ...
            回复
                    ...
                    <a href="javascript:void(0)" class="el-button el-button--small is-plain el-button--primary"
                       v-if="!scope.row['reply_to_id']" @click="reset();query.reply_to_id = scope.row[field];search()">
                        查看被回复
                    </a>
                </template>
            </el-table-column>
