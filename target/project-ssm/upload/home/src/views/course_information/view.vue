				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_course_information v-if="$check_action('/course_information/table','get')"></view_course_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_course_information from "../../components/diy/view_course_information.vue";
	export default {
		data() {
			return {
			};
